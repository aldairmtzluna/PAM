...
if( !MX.isMetaHelper() ) {
  ...
  (function() {
    ...
    wf.src = ('https:' == document.location.protocol ? 'https' : 'http') +
      ...
      '://localhost/PAM/frame/ajax/webfont.js';
...
MX.secBuilder = function () {
	...
	'<header>'+
		'<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">'+
            ...
            '<img src="/PAM/frame/images/logoheader.svg" width="128" height="48" alt="Página de inicio, Gobierno de México">'+
  ...
  '<footer class="main-footer">'+
    '<div class="list-info">'+
      '<div class="container">'+
        '<div class="row">'+
          '<div class="col-sm-3">'+
            '<img data-v-9e928f9a="" src="/PAM/frame/images/logoheader.svg" href="/" alt="logo gobierno de México" class="logo_footer" style="max-width: 90%;">'+ 
          '</div>'+
          '<div class="col-sm-3">'+
            '<h5>Enlaces</h5>'+
            '<ul>'+
